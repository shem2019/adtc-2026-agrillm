# AgriLLM: full technical report

This is the long-form companion to [`REPORT.md`](REPORT.md), which is the
submission writeup in the template's five sections. This file keeps the complete
record: how the training data was built, every training run, how the shipped
